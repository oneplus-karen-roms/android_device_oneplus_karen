...
# TARGET_KERNEL_CONFIG := k6893v1_64_ab_defconfig
...
BOARD_AVB_VBMETA_VENDOR := vendor odm product
...
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/vendor_overlay/etc/fstab.$(TARGET_BOARD_PLATFORM)
...
PRODUCT_COPY_FILES += $(DEVICE_PATH)/vendor_overlay/etc/fstab.$(TARGET_BOARD_PLATFORM):$(TARGET_COPY_OUT_RECOVERY)/root/first_stage_ramdisk/fstab.$(TARGET_BOARD_PLATFORM)
